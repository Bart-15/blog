import { Table, TableBody, TableContainer, TableHead, TableRow, Button, Paper, FormControlLabel} from '@mui/material'
...
import {deletePost, toggleIsFeatured} from '../../store/actions/postAction';
...
const Posts = ({posts}) => {
  ...
  const handleIsFeatured = (id) => {
    dispatch(toggleIsFeatured(id))
  }
                      ...
                      {posts.map((post) => (
                        <StyledTableRow key={post._id}>
                          ...
                          <StyledTableCell align="left"><FormControlLabel
                                control={<MaterialUISwitch sx={{ m: 1 }} defaultChecked={post.isFeatured} onChange={() => handleIsFeatured(post._id)} />}
                                label=" "/>
                          </StyledTableCell>
